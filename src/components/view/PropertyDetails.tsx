    ...
    return (
      <div className="space-y-8 mt-8">
        ...
        <div className="bg-white border rounded p-6 shadow">
          ...
          <div className="border-t pt-4 grid grid-cols-1 sm:grid-cols-2 gap-x-6 text-sm text-gray-700">
            {/* Left Column */}
            <div className="space-y-4">
              <div className="flex justify-between border-b pb-2">
                <p className="font-semibold">Address</p>
                <p className="text-right">2436 SW 8th St</p>
              </div>
              <div className="flex justify-between border-b pb-2">
                <p className="font-semibold">City</p>
                <p className="text-right">Miami</p>
              </div>
              <div className="flex justify-between border-b pb-2">
                <p className="font-semibold">State/County</p>
                <p className="text-right">Florida</p>
              </div>
            </div>
            ...
            <div className="space-y-4 mt-6 sm:mt-0">
              <div className="flex justify-between border-b pb-2">
                ...
                <p className="text-right">33140</p>
              </div>
              <div className="flex justify-between border-b pb-2">
                <p className="font-semibold">Area</p>
                <p className="text-right">West Flagger</p>
              </div>
              <div className="flex justify-between border-b pb-2">
